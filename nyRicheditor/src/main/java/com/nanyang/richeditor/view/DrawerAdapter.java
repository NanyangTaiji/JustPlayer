...
public class DrawerAdapter extends BaseAdapter {
	//TODO ny
	private static final int LENGTH = 8;        //updated with number of items

	public static final int TYPE_SPLITTER = 0;
	public static final int TYPE_GESTURE = 1;
	public static final int TYPE_JSON_VIEW = 4;
	...
	public static final int TYPE_JSON_TO_DB = 8;
	public static final int TYPE_SYNCHRONIZE = 9;
