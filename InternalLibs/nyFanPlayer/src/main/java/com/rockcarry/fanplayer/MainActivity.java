...
import static com.rockcarry.fanplayer.MediaPlayer.PLAYER_INIT_PARAMS;
...
public class MainActivity extends Activity {
    ...
    private static final String DEF_PLAYER_OPEN_URL = "http://192.168.10.113:8888";
    private MediaPlayer mPlayer = null;
    private SizeObservedRelativeLayout mRoot = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_VIEW.equals(action)) {
            ...
            mURL = NyFileUtil.getPath(this, uri);

            assert mURL != null;
            mURL = mURL.substring(mURL.indexOf("/storage/"));
        ...
        mRoot = (SizeObservedRelativeLayout) findViewById(R.id.player_root);
        mRoot.setOnSizeChangedListener(new SizeObservedRelativeLayout.OnSizeChangedListener() {
            @Override
    ...
    public void onResume() {
        super.onResume();
        if (!mIsLive) playPauseToggle(true);
    }

    @Override
    public void onPause() {
        if (!mIsLive) playPauseToggle(false);
        super.onPause();
    }
    ...
    private void playPauseToggle(boolean play) {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_UDPATE_VIEW_SIZE: {
                    if (mPlayer != null && mPlayer.initVideoSize(mVideoViewW, mVideoViewH, mSurfaceView)) {
