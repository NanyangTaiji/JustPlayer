...
class MuxRender {
    ...
    MuxRender(@NonNull MediaMuxer muxer) {
        this.muxer = muxer;
    ...
    void onSetOutputFormat() {
        ...
        if (videoFormat != null && audioFormat != null) {
            ...
            Log.e(TAG, "Added track #" + videoTrackIndex + " with " + videoFormat.getString(MediaFormat.KEY_MIME) + " to muxer");
            audioTrackIndex = muxer.addTrack(audioFormat);
            Log.e(TAG, "Added track #" + audioTrackIndex + " with " + audioFormat.getString(MediaFormat.KEY_MIME) + " to muxer");
