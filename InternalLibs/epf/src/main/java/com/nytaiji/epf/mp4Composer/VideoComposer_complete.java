...
class VideoComposer_complete {
    ...
    private EncoderSurface_share_context encoderSurface;
    ...
    VideoComposer_complete(@NonNull MediaExtractor mediaExtractor, int trackIndex,
    ...
    void setUp(GlFilter filter,
        ...
        encoderSurface = new EncoderSurface_share_context(encoder.createInputSurface(), shareContext);
