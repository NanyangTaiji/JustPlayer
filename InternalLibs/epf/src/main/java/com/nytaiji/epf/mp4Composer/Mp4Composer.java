...
import com.nytaiji.epf.mp4Composer.FdSource.FdInterface;
import com.nytaiji.epf.mp4Composer.FdSource.FileDescriptorFd;
import com.nytaiji.epf.mp4Composer.FdSource.FilePathFd;
import com.nytaiji.epf.mp4Composer.FdSource.UriFd;
import com.nytaiji.epf.composer.FillMode;
import com.nytaiji.epf.composer.FillModeCustomItem;
import com.nytaiji.epf.composer.Rotation;
...
public class Mp4Composer {
    ...
    private final FdInterface srcDataSource;
  ...
  //  private Logger logger;
    ...
    private FdInterface.Listener errorDataSource = new FdInterface.Listener() {
        @Override
  ...
  /*  public Mp4Composer logger(@NonNull final Logger logger) {
        ...
        getExecutorService().execute(new Runnable() {
            ...
            public void run() {
             ...
             //   }
                ...
                Log.d(TAG, "rotation = " + Rotation.fromInt(rotation.getRotation() + videoRotate));
                ...
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        if (e instanceof MediaCodec.CodecException) {
                            Log.e(TAG, "This devicel cannot codec with that setting. Check width, height, bitrate and video format.", e);
                            notifyListenerOfFailureAndShutdown(e);
                            return;
                        }
                    }

                    Log.e(TAG, "Unable to compose the engine", e);
                    notifyListenerOfFailureAndShutdown(e);
                    return;
                }
    ...
    @Nullable
    private Integer getVideoRotation(FdInterface dataSource) {
     ...
     */
    @Nullable
    private Size getVideoResolution(FdInterface dataSource) {
        ...
        try {
            ...
            Log.e("MediaMetadataRetriever", "getVideoResolution IllegalArgumentException", e);
            return null;
        } catch (RuntimeException e) {
            Log.e("MediaMetadataRetriever", "getVideoResolution RuntimeException", e);
            return null;
        } catch (Exception e) {
            Log.e("MediaMetadataRetriever", "getVideoResolution Exception", e);
            return null;
        } finally {
            try {
                if (retriever != null) {
