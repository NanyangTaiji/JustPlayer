...
class AudioComposer_trim implements IAudioComposer {
    ...
    AudioComposer_trim(@NonNull MediaExtractor mediaExtractor, int trackIndex,
    ...
    public boolean stepPipeline() {
        ...
        if (sampleSize > bufferSize) {
            Log.e(TAG, "Sample size smaller than buffer size, resizing buffer: " + sampleSize);
