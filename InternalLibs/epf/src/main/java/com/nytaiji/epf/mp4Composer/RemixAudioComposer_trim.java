...
class RemixAudioComposer_trim implements IAudioComposer {
    ...
    private AudioChannel_no_buffer audioChannel;
    ...
    RemixAudioComposer_trim(MediaExtractor extractor, int trackIndex,
    ...
    public void setup() {
        ...
        audioChannel = new AudioChannel_no_buffer(decoder, encoder, outputFormat);
    }
    ...
    private int drainDecoder(long timeoutUs) {
        ...
        if ((bufferInfo.flags & MediaCodec.BUFFER_FLAG_END_OF_STREAM) != 0) {
            isDecoderEOS = true;
            audioChannel.drainDecoderBufferAndQueue(AudioChannel_no_buffer.BUFFER_INDEX_END_OF_STREAM, 0);
