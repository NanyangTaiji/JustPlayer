...
class Mp4ComposerEngine {
    ...
    private VideoComposer_complete videoComposer;
   ...
   // private final Logger logger;
    ...
    void compose(
            final FdInterface srcDataSource,
        ...
        try {
            ...
            videoComposer = new VideoComposer_complete(mediaExtractor, videoTrackIndex, actualVideoOutputFormat, muxRender, timeScale, trimStartMs, trimEndMs);
            ...
            if (audioTrackIndex >= 0 && mediaMetadataRetriever.extractMetadata(MediaMetadataRetriever.METADATA_KEY_HAS_AUDIO) != null && !mute) {
                ...
                if (timeScale < 2 && outputMediaFormat.equals(inputMediaFormat)) {
                    audioComposer = new AudioComposer_trim(mediaExtractor, audioTrackIndex, muxRender, trimStartMs, trimEndMs);
                } else {
                    audioComposer = new RemixAudioComposer_trim(mediaExtractor, audioTrackIndex, outputMediaFormat, muxRender, timeScale, trimStartMs, trimEndMs);
                }
