...
import com.nytaiji.nybase.AppPref;
...
public final class DeviceUtils {
    ...
    public static boolean isFireTv(Context context) {
        ...
        isFireTV =
                context.getApplicationContext().getPackageManager().hasSystemFeature(AMAZON_FEATURE_FIRE_TV);
        return isFireTV;
    }
    ...
    public static boolean isTablet(@NonNull final Context context) {
        final String tabletModeSetting = AppPref.getInstance(context).getString(R.string.tablet_mode_key,"");
