...
public class GestureUnlockView extends View {
    ...
    public GestureUnlockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (array != null) {
            colorNormal = array.getColor(R.styleable.GestureUnlockView_color_normal, Color.WHITE);
            ...
            strokeWidth = array.getDimension(R.styleable.GestureUnlockView_stroke_line_width, 3.0f);
