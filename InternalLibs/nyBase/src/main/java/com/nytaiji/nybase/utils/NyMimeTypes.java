...
import static com.nytaiji.nybase.utils.NyFileUtil.getFileExtension;
...
public final class NyMimeTypes {
    ...
    //copy from Exoplayer 2's MimeTypes
    ...
    public static String getMimeTypeFromPath(String url) {
        if (url.contains("youtu")||url.contains("videoplayback")) return "video/mp4";
        String ext = getFileExtension(url);
        if (ext != null && getMimeTypeFromExtension(ext) != null)
    ...
    public static boolean isCommonMimeType(String mimeType1, String mimeType2){
        return Objects.equals(mimeType1.split("/")[0], mimeType2.split("/")[0]);
    }
