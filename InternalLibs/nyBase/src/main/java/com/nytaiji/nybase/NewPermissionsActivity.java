...
public abstract class NewPermissionsActivity extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private final OnPermissionGranted onPermissionGranted = isGranted -> {
        if (isGranted) {
            ...
            Toast.makeText(NewPermissionsActivity.this, R.string.grantfailed, Toast.LENGTH_SHORT).show();
    ...
    private void showPermissionRationaleDialog(String permission, int code, int rationaleMessageId) {
        new AlertDialog.Builder(this, R.style.DialogTheme)
                ...
                .setPositiveButton(R.string.grant, (dialog, which) -> {
                    ActivityCompat.requestPermissions(NewPermissionsActivity.this, new String[]{permission}, code);
                    dialog.cancel();
                })
                .setCancelable(false)
                .show();
    ...
    public void showToastInCenter(String message) {
        Toast.makeText(NewPermissionsActivity.this, message, Toast.LENGTH_SHORT).show();
    }


    //------------------------------//

    public void clearAmazeStreamer() {
