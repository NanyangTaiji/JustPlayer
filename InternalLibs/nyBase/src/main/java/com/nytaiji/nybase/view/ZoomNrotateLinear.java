...
import com.nytaiji.nybase.utils.ScaleHelper;
import com.nytaiji.nybase.R;


/**
 * improve  xuliwen's zoomgroup (2021-5-300
 * <p>
 ...
 */
public class ZoomNrotateLinear extends LinearLayout {


    private static final String TAG = "ZoomLayout";
    private static final float DEFAULT_MIN_ZOOM = 1f;
    ...
    private ZoomStatusListener mZoomStatusListener;
    ...
    public void setZoomInOnly() {
        mMinZoom = 1f;
        mMaxZoom = 4f;
    }

    public void setZoomOutOnly() {
        mMinZoom = 0.25f;
        mMaxZoom = 1f;
    }

    public void setRotateOnly() {
        mMinZoom = 1f;
        mMaxZoom = 1f;
    }
    ...
    public ZoomNrotateLinear(Context context) {
        super(context);
        init(context, null);
    }

    public ZoomNrotateLinear(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ZoomNrotateLinear(Context context, AttributeSet attrs, int defStyle) {
    ...
    private final ScaleGestureDetector.SimpleOnScaleGestureListener mSimpleOnScaleGestureListener = new ScaleGestureDetector.SimpleOnScaleGestureListener() {
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
            if (mZoomStatusListener != null) {
                mZoomStatusListener.zoomStatus(!(newScale <= 1f));
            }
    ...
    private final GestureDetector.SimpleOnGestureListener mSimpleOnGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public boolean onDown(MotionEvent e) {
            ...
            //TODO NY
            if (e.getPointerCount() < 2 && mZoomLayoutGestureListener != null)
                mZoomLayoutGestureListener.onSingleTap(e);
            return true;
        }
        ...
        public boolean onDoubleTap(MotionEvent e) {
            ...
            if (mZoomLayoutGestureListener != null) {
                mZoomLayoutGestureListener.onDoubleTap(e);
            }
            //TODO ny 2023-5-21
            return true; //do not pass;
        }
    ...
    public void smoothScale(float newScale, int centerX, int centerY) {
        ...
        if (mZoomStatusListener != null && newScale <= 1f) mZoomStatusListener.zoomStatus(false);
        notifyInvalidate();
    }
    ...
    public void setmZoomStatusListener(ZoomStatusListener zoomStatusListener) {
        mZoomStatusListener = zoomStatusListener;
    }
    ...
    public interface ZoomStatusListener {
        ...
        void zoomStatus(boolean yesOrNo);
    }
}