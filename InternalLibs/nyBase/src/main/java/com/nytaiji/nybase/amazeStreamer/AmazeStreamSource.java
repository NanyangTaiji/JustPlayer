...
import com.nytaiji.nybase.network.RandomAccessStream;

import java.io.IOException;
import java.io.InputStream;

public class AmazeStreamSource extends RandomAccessStream {
  protected long fp;
  protected String name;
  private InputStream inputStream;

  public AmazeStreamSource(String fileName, long length, InputStream inputStream) {
    super(length);
