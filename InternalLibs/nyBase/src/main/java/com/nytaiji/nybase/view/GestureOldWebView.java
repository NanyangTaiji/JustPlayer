...
public class GestureOldWebView extends OldNyWebView implements GestureDetector.OnGestureListener, View.OnTouchListener {
    ...
    public GestureOldWebView(Context context) {
        this(context, null);
    }

    public GestureOldWebView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public GestureOldWebView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(Context context) {
        ...
        mContext=context;
        // ****************音量/进度/亮度*********************
        root = (RelativeLayout) LayoutInflater.from(context).inflate(R.layout.gesture_layout, null);
        ...
        viewObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                GestureOldWebView.this.getViewTreeObserver().removeGlobalOnLayoutListener(this);
