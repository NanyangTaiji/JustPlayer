...
public class StreamingCipherInputStream extends CipherInputStream {
    ...
    public StreamingCipherInputStream(InputStream inputStream, EncryptUtil.CTRnoPadding ces) throws IOException {
        super(inputStream, ces.cipher);
        mUpstream = inputStream;
        mCipher = ces.cipher;
        mSecretKeySpec = ces.secretKeySpec;
        mIvParameterSpec = ces.ivParameterSpec;
    }
