package com.nytaiji.zoom.collegeView;
...
public class MultiTouchListener implements OnTouchListener {
    ...
    public boolean isRotateEnabled = true;  //Set true if allow to rotate
    ...
    public void setScaleFactor(float minimumScale, float maximumScale){
        this.maximumScale=maximumScale;
        this.minimumScale=minimumScale;
    }

    public void setCrossBoundries(boolean cross){
        canCrossParentBoundries=cross;
    }

    public void setRotation (boolean rotation){
        isRotateEnabled = rotation;
    }
