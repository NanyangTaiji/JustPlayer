...
import com.nytaiji.zoom.R;
import com.nytaiji.zoom.ScaleHelper;
 ...
 * 
 */
public class ZoomLayout_1 extends LinearLayout {
    ...
    public ZoomLayout_1(Context context) {
        super(context);
        init(context, null);
    }

    public ZoomLayout_1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ZoomLayout_1(Context context, AttributeSet attrs, int defStyle) {
