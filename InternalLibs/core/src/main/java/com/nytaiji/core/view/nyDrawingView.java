...
public class nyDrawingView extends View {
    ...
    private boolean mDrawMode = true;
    private float mX, mY;
    private float mProportion = 0;
    private Matrix matrix;
    private LinkedList<DrawPath> savePath;
    private DrawPath mLastDrawPath;
    private float mPaintBarPenSize = 9;
    private int mPaintBarPenColor;

    public nyDrawingView(Context c) {
        this(c, null);
    }

    public nyDrawingView(Context c, AttributeSet attrs) {
        this(c, attrs, 0);
    }

    public nyDrawingView(Context c, AttributeSet attrs, int defStyle) {
    ...
    public void undo() {
        ...
        if (savePath != null && savePath.size() > 0) {
            ...
            if (mOriginBitmap != null) loadImage(mOriginBitmap);
