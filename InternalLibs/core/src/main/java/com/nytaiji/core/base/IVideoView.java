...
public interface IVideoView {
     ...
     * @return
     */
    RenderContainerFrame getRenderContainerViewOffParent();
     ...
     * @return
     */
    RenderContainerFrame getRenderContainerFrame();

    /**
     * 添加播放器画面视图，到播放器界面上
     *
     * @param renderContainerFrame
     */
    void addRenderContainer(RenderContainerFrame renderContainerFrame);
    ...
    void setVideoScale(BaseConstants.ScaleType scale);
}
