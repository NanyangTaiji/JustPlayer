...
public class BrightnessDialog {
    ...
    public void show(Context context, int percent, View anchorView) {
        if (dialog == null) {
            ...
            if (localView.findViewById(R.id.app_video_brightness) instanceof TextView) {
        ...
        String brightTx = context.getString(R.string.percentage, percent);
        if (mBrightnessDialogTv != null)
            mBrightnessDialogTv.setText(brightTx);
    }
