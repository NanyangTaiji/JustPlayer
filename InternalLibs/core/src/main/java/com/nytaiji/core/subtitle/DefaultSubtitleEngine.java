...
import com.nytaiji.core.subtitle.cache.SubtitleCache;
...
public class DefaultSubtitleEngine implements SubtitleEngine {
    ...
    private BasePlayer mMediaPlayer;
    private final SubtitleCache mCache;
    ...
    @Override
    public void bindToMediaPlayer(final BasePlayer mediaPlayer) {
