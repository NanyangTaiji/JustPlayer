...
import com.nytaiji.nybase.utils.AnimatedGifEncoder;
...
public class GifCreateHelper {
    ...
    private VideoGifSaveListener mGSYVideoGifSaveListener;
    ...
    public GifCreateHelper(IRenderView standardGSYVideoPlayer, VideoGifSaveListener gsyVideoGifSaveListener) {
    ...
    public GifCreateHelper(IRenderView standardGSYVideoPlayer, VideoGifSaveListener gsyVideoGifSaveListener,
        ...
        renderView = standardGSYVideoPlayer;
    ...
    private void startSaveBitmap() {
        ...
        renderView.saveFrame(file, false, new VideoShotSaveListener() {
            @Override
