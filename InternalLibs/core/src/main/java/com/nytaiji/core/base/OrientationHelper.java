...
public class OrientationHelper {
    ...
    private final WeakReference<IVideoView> videoViewWeakReference;
    ...
    private void init() {
        ...
        orientationEventListener = new OrientationEventListener(videoView.getPlayView().getContext()) {
            ...
            public void onOrientationChanged(int rotation) {
                ...
                //TODO
                videoView.setVideoScale(SCALE_MATCH_PARENT);
                videoView.getRenderContainerFrame().getIRenderView().setDisplayScale(SCALE_MATCH_PARENT);
                //TODO
    ...
    private static class OrientationRunnable implements Runnable {
        ...
        private final WeakReference<IVideoView> weakReference;
