...
public class GLFilterBase extends GlFilter
{
     ...
     */
    @Override
    public void draw(int sourceTexture, GlFrameBufferObject targetBuffer)
    {
     ...
     */
    protected void drawUsingProgram(int program, int texToDraw, GlFrameBufferObject drawTarget)
    {
