...
import com.nytaiji.core.view.FsFilterVideoFrame;
import com.nytaiji.exoplayer.GoogleExoPlayer;


public class FsFilterView extends FsFilterVideoFrame {
    private static final String TAG = "FSAdvancedVideoView";
    public PlayerConfig playerConfig;
    private final Context mContext;
    private boolean toReroute = true;
    private boolean firstTime = true;

    public FsFilterView(@NonNull Context context) {
        this(context, null);
    }

    public FsFilterView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public FsFilterView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
