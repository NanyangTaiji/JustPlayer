...
public class PlayerActivity extends Activity {
    ...
    protected boolean videoLoading;
    ...
    protected CustomDefaultTimeBar timeBar;
    private boolean restoreOrientationLock;
    protected boolean restorePlayState;
    ...
    protected static boolean isTvBox;
    public static boolean locked = false;
    protected Thread nextUriThread;
