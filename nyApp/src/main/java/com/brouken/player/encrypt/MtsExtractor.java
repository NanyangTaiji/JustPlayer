  ...
  private class PmtReader implements SectionPayloadReader {
    ...
    public void consume(ParsableByteArray sectionData) {
      ...
      if (hlsMode && id3Reader == null) {
        ...
        //TODO ny
        TsPayloadReader.EsInfo dummyEsInfo = new TsPayloadReader.EsInfo(TS_STREAM_TYPE_ID3, null, TsPayloadReader.EsInfo.AUDIO_TYPE_UNDEFINED,null,new byte[0]);
    ...
    private TsPayloadReader.EsInfo readEsInfo(ParsableByteArray data, int length) {
      ...
      //TODO ny
      return new TsPayloadReader.EsInfo(streamType, language, TsPayloadReader.EsInfo.AUDIO_TYPE_UNDEFINED,null,
