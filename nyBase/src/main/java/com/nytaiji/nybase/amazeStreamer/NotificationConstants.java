...
public class NotificationConstants {
     ...
     */
    public static void setMetadata(Context context, String AppName, NotificationCompat.Builder notification, int type) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            switch (type) {
                case TYPE_NORMAL:
                    createNormalChannel(context,AppName);
                    break;
                default:
    ...
    private static void createNormalChannel(Context context, String AppName) {
