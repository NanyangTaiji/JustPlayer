 ...
 * @since
 */
public class OldNyWebView extends WebView {
    ...
    public OldNyWebView(Context context) {
        super(context);
        init(context);
    }

    public OldNyWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public OldNyWebView(Context context, AttributeSet attrs, int defStyleAttr) {
