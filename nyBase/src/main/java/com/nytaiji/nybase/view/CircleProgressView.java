...
import static com.nytaiji.nybase.utils.NyFileUtil.getResColor;
...
public class CircleProgressView extends View {
    ...
    public CircleProgressView(Context context, @Nullable AttributeSet attrs) {
        ...
        backgroundColor = typedArray.getColor(R.styleable.CircleProgressView_progressBackgroundColor, getResColor(R.color.md_grey_500));
        progressColor = typedArray.getColor(R.styleable.CircleProgressView_progressColor, getResColor(R.color.colorPrimary));
        progress = typedArray.getInt(R.styleable.NumberProgressBar_progress, 0);
        ...
        textColor = typedArray.getColor(R.styleable.CircleProgressView_textColor, getResColor(R.color.black_overlay));
        typedArray.recycle();
        init();
    }
