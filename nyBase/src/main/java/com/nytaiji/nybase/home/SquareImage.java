...
public class SquareImage extends View {
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawRect(centerX - outerRadius, centerY - outerRadius, centerX + outerRadius, centerY + outerRadius, circlePaint);
        super.onDraw(canvas);
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        centerX = w / 2;
        centerY = h / 2;
        outerRadius = (int) Math.min(w, h) / 2;
        //best size 28dp icons
    }
