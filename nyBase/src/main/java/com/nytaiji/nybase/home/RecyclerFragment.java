...
import com.nytaiji.nybase.BaseFragment;
...
public class RecyclerFragment extends BaseFragment {
    ...
    private void ensureList() {
        ...
        if (root instanceof RecyclerView) {
            ...
            mListContainer = root.findViewById(R.id.gestureview);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_recycler_ny, container, false);
    }
    ...
    public void setEmptyText(CharSequence text) {
        ...
        mStandardEmptyView.setVisibility(getVisibility(!TextUtils.isEmpty(text)));
        mEmptyText = text;
    }
