...
public class PermissionActivity extends AppCompatActivity implements
    ...
    private void ensureStorageAccess() {
        ...
        if (supportsExternalStorageManager(PermissionActivity.this)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
                if (!isManageAppAllFilesAccessPermissionIntentResolved(PermissionActivity.this)) {
                    RequestAllFilesAccessRationale.show(PermissionActivity.this);
            ...
            if (ActivityCompat.checkSelfPermission(PermissionActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) !=
                ...
                if (shouldShowRequestPermissionRationale(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    RequestStoragePermissionRationale.show(PermissionActivity.this);
                } else {
    ...
    private void onRequestStoragePermissionResult(boolean isGranted) {
        if (isGranted) {
            ...
            RequestStoragePermissionInSettingsRationale.show(PermissionActivity.this);
        }
    }
    ...
    private void onRequestNotificationPermissionResult(boolean isGranted) {
        if (isGranted) {
            ...
            RequestNotificationPermissionRationale.show(PermissionActivity.this);
        } else {
            RequestNotificationPermissionInSettingsRationale.show(PermissionActivity.this);
        }
    }
    ...
    private class RequestPermissionInSettingsContract extends ActivityResultContract<Boolean, Boolean> {
        ...
        @Override
        public Boolean parseResult(int resultCode, @Nullable Intent intent) {
            return ActivityCompat.checkSelfPermission(PermissionActivity.this, permissionName) ==
                    PackageManager.PERMISSION_GRANTED;
        }
    }
