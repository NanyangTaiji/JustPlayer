...
import static com.nytaiji.nybase.utils.NyFileUtil.SEPARATOR_RESOLUTION;
...
import com.nytaiji.nybase.model.Info;
...
//        return string.replaceAll("'", "''");
   ...
   /*
    ...
    public static boolean updateNyVideo(Context context, @NonNull NyVideo video) {
        ContentResolver mContentResolver = context.getContentResolver();
