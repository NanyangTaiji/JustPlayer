...
public final class Constants {
    ...
    public static final String GOOGLE_PLAYER="GOODLE_PLAYER";
    public static final String VLC_PLAYER="VLC_PLAYER";
    public static final String ANDROID_PLAYER="ANDROID_PLAYER";
    public static final String IJK_PLAYER="IJK_PLAYER";
    public static final String FAN_PLAYER="FAN_PLAYER";
    ...
    //---------------//
    // security_prefs.xml
    public static final String PREFERENCE_CRYPT_LEVEL = "crypt_level";
    public static final String PREFERENCE_CRYPT_LEVEL_DEFAULT = "1";
    public static final String PREFERENCE_CRYPT_OVERHEAD = "crypt_overhead";
    public static final String PREFERENCE_CRYPT_TO_DEFAULT_DIR = "crypt_to_default_dir";
    public static final String PREFERENCE_CRYPT_DEFAULT_DIR = "crypt_default_dir";
    public static final String PREFERENCE_CRYPT_DELETE_SOURCE = "crypt_delete_source";
